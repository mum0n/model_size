...
p$theta = list(
    f.imm = c(
10.5299, -2.1616, -0.9348, 1.0010, 1.8434, 0.4695, 1.4841, 0.7881, 0.1155, -0.1594, 2.2816, 3.1665, 2.6746, -2.2832, 2.9395, 28.8553, -0.6389, -0.0204
    ),
    f.mat = c(
9.5326, -0.7771, 1.3083, 1.8652, -0.6052, 1.5363, 0.0204, 0.1819, 0.2174, -3.1332, -2.33, 2.0505, 1.0892, -3.8373, 12.1444, -2.891, -0.6585, 1.3005
    ),
    m.imm = c(
9.9185, -2.5078, -2.341, 2.1849, 1.5128, 1.3547, 1.502, 0.0052, -0.4524, -0.2573, -1.3309, 4.2263, 2.0461, -2.2527, 4.3384, -1.3941, -0.6868, 0.8241
    ...
    m.mat = c(
9.9007, 0.2020, 1.4624, 2.1964, 0.5940, 2.5761, 1.9452, 0.0102, 0.2808, 1.2686, -0.1217, 3.2817, 4.2241, -2.4502, 4.4544, -1.1382, -0.3519, 1.0917
    ) 
)
