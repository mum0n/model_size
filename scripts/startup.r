...
p$theta = function(bioclass) {
  ...
  out = switch( bioclass,
    ...
    f.mat = c(
      6.4364, 14.0605, 11.3605, 7.8415, 4.7670, 4.2591, 4.6586, 2.0921, 4.3206, 1.8505, 2.2031, 6.1731, 4.9362, 9.0836, 12.1969, 15.9643, 6.4769, 25.2386
    ),
    m.imm = c(
    ...
    m.mat = c(
      9.8863, 0.1993, 1.4974, 2.1585, 0.5027, 2.5765, 2.1668, 0.0062, 1.8474, -2.0166, 0.4320, 3.7706, 4.9270, -2.4361, 4.4546, -1.1327, -0.3141, 1.0652
    ),
    NULL
  )
  return(out) 
