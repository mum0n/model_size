...
post_stratified_weights = function(p, action="load", nposteriors = 100, mc.cores = 2 ) {

    fnout = file.path( p$modeldir, "post_stratified_weights.rdz" ) 
    ...
    for (sexid in c("female", "male")) {
        ...
        O$post_stratified_weight = O$auid_prob_mean / O$individual_prob_mean   # will add surface area later
