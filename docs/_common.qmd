...
#| label: load-data-from-R
  ...
  data_dump_file = file.path( data_loc, "assessments",  year_assessment, "current_results.rdz")
  ...
  if (file.exists(data_dump_file))  {
    out = read_write_fast(data_dump_file)
    # invisible( out ) 
    ...
    read_write_fast( data=objects_to_save, fn=data_dump_file  )
